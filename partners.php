            ...
            <div  class="container">
                <nav class="navbar navbar-expand-lg navbar-light" id="nav" >
                    ...
                    <div class="ml-auto ml-5 mt-2"  style="right:-32px">
                            <span>Fr</span>
                            <a href="./patners.php?lang=fr"><img src="./assets/img/lang/fr.png"
                                                                  width="26" height="26" alt=""
                                                                  title="<?php echo $lang['fr'];  ?>"
                                ></a>
                            <span>En</span>
                            <a href="./partners.php?lang=en"><img src="./assets/img/lang/en.png"
                                                                  width="26" height="26" alt=""
...
<div class="row" align="center">
              ...
              <div class="col-md-4" style="margin-top: 5rem;">
                  <div class="" align="center">
                      <h1 style="font-size:75px"><?php echo $lang['about']['partners']['f0']['0']; ?></h1>
                      <p ><?php echo $lang['about']['partners']['f0']['1']; ?></p>
                  </div>
              </div>
              <div class="col-md-4 ">
    ...
    <div class="container-fluid ">
      <div class="row">
        <div class="col-md-6 info lce-patner" style="padding-left:4rem">
          <h3 class="text-o"><?php echo $lang['about']['partners']['f1']; ?></h3>
          <p>
          <?php echo $lang['about']['partners']['f2']; ?>          </p>
        </div>
        <div class="col-md-6 info from-right" align="center">
            <img src="assets/img/patner-0.png" width="70%" alt="">
        </div>
      </div>
    </div>
    <!-- end find partners -->
    ...
    <div class="container-fluid ">
      <div class="row">
        <div class="col-md-6 from-left info" align="center">
            <img src="assets/img/patner-2.png" width="70%" alt="">
        </div>
        <div class="col-md-6 info lce-patner" style="padding-right:4rem">
          <h3 class="text-o"><?php echo $lang['about']['partners']['f3']; ?></h3>
          <p>              
          <?php echo $lang['about']['partners']['f4']; ?>          </p>
        </div>
      </div>
    </div>
    <!-- end support -->
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 info lce-patner" style="padding-left:4rem">
        <h3 class="text-o"><?php echo $lang['about']['partners']['f5']; ?></h3>
        <p><?php echo $lang['about']['partners']['f6']; ?></p>
      </div>
      <div class="col-md-6 from-right info" align="center">
          <img src="assets/img/patner-3.png" width="70%" alt="">
      </div>
    </div>
  </div>
  <!-- end operate -->
