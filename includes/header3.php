                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                      <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                          <a class="nav-link text" href="../index.php">Accueil <span class="sr-only">(current)</span></a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="about.php">Qui sommes-nous ?</a>
                              <a class="dropdown-item" href="join-team.php">Carrières</a>
                              <a class="dropdown-item" href="partners.php">Partenaires</a>                              
                              <a class="dropdown-item" href="#">Galerie</a>
                                
                          </li>
                      </ul>
                      <form class="form-inline my-2 my-lg-0">
                        <a href="contact.php" class="btn btn-outline-light my-2 my-sm-0" style="border-radius: 0;" type="submit" id="cbtn">Contactez-nous</a>
                      </form>
                    </div>
                  </nav>
            </div>
